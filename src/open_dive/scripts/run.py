...
def main():
    ...
    parser.add_argument("--save_path", help="Optional path for saving the image.")
    parser.add_argument(
        "--headless",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=int,
        nargs=2,
        help="Value range to pass to slicer. Default is min/max of image.",
    )
    parser.add_argument(
        "--volume_idx",
        type=int,
    ...
    parser.add_argument(
        ...
        help="Tractogram(s) to plot with slices. Can provide multiple files.",
    )
    parser.add_argument(
        "--tractography_values",
        type=float,
    ...
    parser.add_argument(
        ...
        type=float,
        nargs=2,
        help="Range to use for the colormap. Default is 0 to 1.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='Spherical harmonic basis, either "descoteaux07" or "tournier07". Default is "descoteaux07".',
    )
    parser.add_argument(
        "--scale",
        type=float,
